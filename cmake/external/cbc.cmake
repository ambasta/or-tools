ADD_DEFINITIONS(-DCBC_THREAD_SAFE -DCBC_NO_INTERRUPT)
FOREACH(COIN_PROJECT CoinUtils Osi Clp Cgl Cbc)
    ...
    SET_PROPERTY(TARGET ${COIN_PROJECT}
        ...
        ${CMAKE_CURRENT_BINARY_DIR}/install/lib/lib${COIN_PROJECT}.a)
    SET_PROPERTY(TARGET ${COIN_PROJECT}
    ...
    IF (${COIN_PROJECT} STREQUAL "Cbc" OR ${COIN_PROJECT} STREQUAL "Clp")
        ...
        SET_PROPERTY(TARGET Osi${COIN_PROJECT}
            PROPERTY IMPORTED_LOCATION
            ${CMAKE_CURRENT_BINARY_DIR}/install/lib/libOsi${COIN_PROJECT}.a)
        ADD_LIBRARY(${COIN_PROJECT}Solver STATIC IMPORTED)
        SET_PROPERTY(TARGET ${COIN_PROJECT}Solver
            PROPERTY IMPORTED_LOCATION
            ${CMAKE_CURRENT_BINARY_DIR}/install/lib/lib${COIN_PROJECT}Solver.a)
    ENDIF()

    ADD_DEPENDENCIES(${COIN_PROJECT} ${COIN_PROJECT}_project)
    GET_PROPERTY(${COIN_PROJECT}_INCLUDE_DIRS TARGET ${COIN_PROJECT} PROPERTY INCLUDE_DIRECTORIES)
ENDFOREACH()
...
LIST(APPEND ${PROJECT_NAME}_INCLUDE_DIRS ${CMAKE_INSTALL_INCLUDEDIR}/${PROJECT_NAME}/coin)
