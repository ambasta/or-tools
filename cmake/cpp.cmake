...
IF(NOT gflags_FOUND)
    ...
    GET_PROPERTY(gflags_INCLUDE_DIRS TARGET gflags PROPERTY INCLUDE_DIRECTORIES)
ENDIF()
...
IF(NOT glog_FOUND)
    ...
    GET_PROPERTY(glog_INCLUDE_DIRS TARGET glog PROPERTY INCLUDE_DIRECTORIES)
ENDIF()
...
IF(NOT Cbc_FOUND)
    IF(NOT MSVC)
        ...
        GET_PROPERTY(Cbc_INCLUDE_DIRS TARGET Cbc PROPERTY INCLUDE_DIRECTORIES)
    ENDIF()
ELSE()
    ADD_DEFINITIONS(-DUSE_CLP -DUSE_CBC)
ENDIF()
